...
try:
    from app.api.customer360_router import router as customer360_router

    app.include_router(customer360_router, prefix="/customer360", tags=["Customer 360"])
    logger.info("✅ Customer 360 router loaded.")
except ImportError as e:
    logger.warning(f"⚠️ Customer 360 router not available yet: {e}")
