            ...
            results.append(
                {
                    ...
                    'dialogue_prompt': "CRITICAL: Call immediately and offer a personalized retention package" if pred.churn_ratio > 0.7 or (customer and customer.support_tickets and customer.support_tickets > 3) else ("HIGH: Send a proactive check-in email" if pred.churn_ratio > 0.4 else "LOW: Standard quarterly review call"),
                }
            )
