...
class TrainingService:
    ...
    # Default IsolationForest hyper-parameters (can be overridden)
    ...
    def train_all(
        ...
        if log_callback: log_callback("Training Lead Propensity IsolationForest Model...")
        ...
        if log_callback: log_callback("Training Customer Churn IsolationForest Model...")
    ...
    def _train_lead_model(
        ...
        try:
            ...
            model = IsolationForest(**self.DEFAULT_IFOREST_PARAMS)
            model.fit(X_train)
