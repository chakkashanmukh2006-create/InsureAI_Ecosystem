            ...
            results.append(
                {
                    ...
                    'dialogue_prompt': "CRITICAL: Call immediately and offer 10% discount" if pred.lead_score > 70 and (lead and lead.last_interaction_days and lead.last_interaction_days < 7) else ("HIGH: Send personalized follow-up email" if pred.lead_score > 50 else ("MEDIUM: Add to re-engagement drip campaign" if lead and lead.last_interaction_days and lead.last_interaction_days > 14 else "LOW: Continue standard nurturing process")),
                }
            )
