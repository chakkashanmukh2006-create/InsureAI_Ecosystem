...
class DashboardService:
    ...
    def get_dashboard(self, db: Session) -> DashboardResponse:
        ...
        """
        total_leads = db.query(LeadPrediction).filter(LeadPrediction.is_fraud == True).count()
        total_customers = db.query(CustomerPrediction).filter(CustomerPrediction.is_fraud == True).count()
